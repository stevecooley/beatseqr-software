...
void run_LCD_setup_routine()
{
  ...
  // lcd.begin(9850);      // 9600 baud is chip comm speed

  // and so my development unit has an older backpack which DOES run at 9600 baud
  // so now I have to switch back and forth and keep track of which is which.
