void run_voice_slider_routine()
{
  // slider mode select button
   slider_mode_select.Update();


  // int tbutton1 = transport_button.clicks == 1;
  if(slider_mode_select.clicks == 1){
...
void slider_serial_message_factory(const char* slider_message_header, int j)
{
  ...
  if(param_rec.clicks == 1 && (slider_message_header == "VL"))
  {
    the_serial_message += "RV";
  }
  else if(param_rec.clicks == 1 && (slider_message_header == "CC"))
  {
    the_serial_message += "RC";
  }
  else if(param_rec.clicks == 1 && (slider_message_header == "NN"))
  {
